...
La [guía rápida](./guia-rapida.md) te lleva de cero a un servidor con Proxmox, Docker y un primer servicio andando, en un solo recorrido, sin importar tu experiencia previa ni el hardware específico que tengas. Cuando quieras el homelab completo — Git propio, CI/CD, Kubernetes, acceso remoto, hogar — seguí con la [guía completa](./guia-completa.md).
:::
