...
| AdGuard Home | LXC (vmid 100) | Actual | 1 vCPU / 512 MB, instalada vía community-script. Reemplaza a Pi-hole — ver [DNS con AdGuard Home](../red/dns-adguard.md). IP estática `192.168.0.93/24` (corregido 2026-09-18, antes `ip=dhcp` — ver incidente abajo). |
